<h2><a href="https://www.geeksforgeeks.org/problems/check-perfect-square5253/1?amp%3Butm_campaign=article_practice_tab&utm_source=geeksforgeeks&%3Butm_medium=ml_article_practice_tab">Check perfect square</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size:18px">Given a positive integer N, check if it is a perfect square or not.<br>
